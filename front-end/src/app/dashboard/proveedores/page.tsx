...
import CardsProveedoresActions from "@/app/components/card-proveedores-actions";
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground mt-2">
              Administra y controla todos los proveedores de tu negocio
            </p>
          </div>
