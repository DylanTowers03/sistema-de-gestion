"""
Django settings for backend_sistema project.
...
SECRET_KEY = 'django-insecure-qzg)3epj$t&9wd&2x)povm@#ds1agi199mp^97dvu*v=j-q^#a'
...
ROOT_URLCONF = 'backend_sistema.urls'
...
WSGI_APPLICATION = 'backend_sistema.wsgi.application'
